...
public class Update {
	 ...
	 * @Version 1.0.0
	 */
	public Update in(String columnName, Object value, boolean isQuotationMark) {
		if (isEmpty(value))
			return this;
		...
		conditions.add(new StringBuilder().append(" and ").append(columnName).append(" in ( ").append(value)
				.append(" )").toString());
		return this;
	}
	 ...
	 * @return
	 */
	public Update notIn(String columnName, Object value, boolean isQuotationMark) {
		if (isEmpty(value))
			return this;
		...
		conditions.add(new StringBuilder().append(" and ").append(columnName).append(" not in ( ").append(value)
				.append(" )").toString());
		return this;
	}
