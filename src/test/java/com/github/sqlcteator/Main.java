...
public class Main {
	...
	public static void name() {
		...
		sql.append(" ao.receive_card_no,ao.elec_req_num,ao.whf_pos_id, ao.form_no,ao.no_fly_yn,ao.batch_no,ao.source_order_no");
		...
		sql.append(" where coop.partner_id = p.id and ao.logistics_coop_id = coop.id and p.partner_code in ('SF','YTO','STO','ZTO','ZJS')");
		sql.append(" )");
